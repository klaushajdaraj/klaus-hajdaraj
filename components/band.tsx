...
export default function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  return (
    <>
      {/* Invisible walls to keep badge in bounds */}
      <RigidBody type="fixed">
        <CuboidCollider args={[15, 0.1, 15]} position={[0, -8, 0]} />
        <CuboidCollider args={[15, 0.1, 15]} position={[0, 18, 0]} />
        <CuboidCollider args={[0.1, 15, 15]} position={[-12, 5, 0]} />
        <CuboidCollider args={[0.1, 15, 15]} position={[12, 5, 0]} />
        <CuboidCollider args={[15, 15, 0.1]} position={[0, 5, -12]} />
        <CuboidCollider args={[15, 15, 0.1]} position={[0, 5, 12]} />
      </RigidBody>
